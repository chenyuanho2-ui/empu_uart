...
/******  GW1NS-4C Specific Interrupt Numbers ************************************/
  ...
  TIMER1_IRQn                   = 9,       /* TIMER 1 Interrupt                     */
	Spare10_IRQn									= 10,      /* Undefined                             */
  USER_INT4_IRQn                = 11,      /* Interrupt handler 4 to user extension */
...
#define I2C               ((I2C_TypeDef    *) I2C_BASE)           //FPGA fabric extended
#define SPI               ((SPI_TypeDef    *) SPI_BASE)           //FPGA fabric extended
